      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-3 mb-6">
            <button onClick={handleGoogleLogin} disabled={loading || IS_DEMO_MODE}
              className={`btn-ghost w-full flex items-center gap-3 ${IS_DEMO_MODE ? "opacity-40 cursor-not-allowed" : ""}`}
              title={IS_DEMO_MODE ? "Google sign-in requires Firebase configuration" : undefined}>
